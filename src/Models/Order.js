export class Order {
    ...
    constructor(email, phone_number, user_id, external_user_id, billing_same_address, recipient_address, credit_card_number, credit_card_name, credit_card_expiry_month, credit_card_expiry_year, credit_card_security_code, billing_address, order_items) { 
       this.email = email;
